<div role="dialog"  class="modal fade " style="display: none;">
    {!! Form::open(array('url' => route('postMessageUsers', array('organiser_id' => $organiser->id)), 'class' => 'reset ajax closeModalAfter')) !!}
        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    ...
                    @lang("User.message_users_title")</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                {!! Form::submit(trans("User.send_message"), ['class'=>"btn btn-success"]) !!}
            </div>
