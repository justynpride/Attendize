<div role="dialog" class="modal fade" style="display: none;">
    {!! Form::open(array('url' => route('postMessageUser', array('user_id' => $user->id)), 'class' => 'ajax
        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    ...
                    @lang("ManageEvent.message_attendee_title", ["user"=>$user->first_name])
                </h3>
            </div>
            <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="custom-checkbox">
                                ...
                                <label for="send_copy">&nbsp;&nbsp;{{ @trans("Message.send_a_copy_to",
                                    ["organiser"=>$user->organiser->email]) }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="help-block">
                    {{ @trans("Message.before_send_message", ["organiser"=>$user->organiser->email]) }}
                </div>
            </div> <!-- /end modal body-->
