<div role="dialog"  class="modal fade " style="display: none;">
    {!! Form::open(array('url' => route('postMessageGroups', array('organiser_id' => $organiser->id)), 'class' => 'reset ajax closeModalAfter')) !!}
        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    ...
                    @lang("Group.message_groups_title")</h3>
            </div>
                                ...
                                <div class="col-lg-12 valign-top panel panel-default">
                                    <div class="nm">
                                        <table class="table table-hover table-email">
                                            ...
                                            <tbody>
                                            @foreach($organiser->messages as $message)
                                                <tr>
                                                    <td class="meta">
            ...
            <div class="modal-footer">
                ...
                {!! Form::submit(trans("Group.send_message"), ['class'=>"btn btn-success"]) !!}
            </div>
