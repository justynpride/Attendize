...
class Event extends MyBaseModel
{
    ...
    {
        return config('attendize.ticket.booking.fee_fixed') + $this->organiser_fee_fixed;
    }
    ...
    {
        return config('attendize.ticket.booking.fee_percentage') + $this->organiser_fee_percentage;
    }
